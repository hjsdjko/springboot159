...
public class TushuxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,TushuxinxiEntity tushuxinxi,
		...
		if(tableName.equals("shangjia")) {
			tushuxinxi.setShangjiazhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R update(@RequestBody Long[] ids, @RequestParam String sfsh, @RequestParam String shhf){
        List<TushuxinxiEntity> list = new ArrayList<TushuxinxiEntity>();
        for(Long id : ids) {
            TushuxinxiEntity tushuxinxi = tushuxinxiService.selectById(id);
            tushuxinxi.setSfsh(sfsh);
            tushuxinxi.setShhf(shhf);
            list.add(tushuxinxi);
        }
        tushuxinxiService.updateBatchById(list);
        return R.ok();
    }
